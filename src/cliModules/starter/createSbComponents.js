...
/**
 * Read component presets and create them on a Storyblok server.  Returned information from the creation request are written to disk.
 */
module.exports = () => {
  return read
    .presets('components')
    .then(presets => {
      const mappingFn = preset => createComponent(preset)
